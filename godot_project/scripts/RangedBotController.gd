...
func ai_decide():
	...
	# opponent, rather than dash staying a purely defensive/escape tool.
	# Doesn't fight the normal kiting game plan — this only fires once the
	# target is nearly dead and putting range between itself and the finish.
